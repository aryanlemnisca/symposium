...
async def suggest_agents(problem_statement: str, mode: str, api_key: str) -> list:
    ...
    prompt = (
        ...
        f'[{{\n'
        f'  "name": "Role_Based_Name (e.g. Product_Thinker, Domain_Expert, Researcher, User_Advocate, Red_Team — use underscores, no spaces)",\n'
        ...
        f'}}]\n\n'
        f'NAMING RULES:\n'
        f'- Use ROLE-BASED names that describe what the agent does (e.g. Product_Thinker, Domain_Expert, Researcher, Red_Team_Skeptic, User_Advocate, GTM_Strategist)\n'
        f'- For domain experts, prefix the role with the domain (e.g. Biotech_Expert, Fintech_Expert, Healthcare_Specialist)\n'
        f'- Names should be 2-3 words joined with underscores — clear and descriptive\n'
        f'- DO NOT use personal first names like Priya, Arjun, Maya — use the role itself as the name\n\n'
